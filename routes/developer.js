...
//bring in middleware for image uploading in portfolio that is multer
...
router.post('/register',(req,res)=>{
    ...
    if(errors.length>0)
    {
        ...
        //check for developer for given email
...
router.post('/OTP/:emailID',(req,res)=>{
    ...
    const transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'vk1975728@gmail.com',
        pass: 'rtsghwnmymwairig'
      }
    });
    ...
    let mailOptions = {
        ...
        subject: 'Welcome to HireMe', // Subject line
        text: 'OTP for HireMe :'+OTP,
        html:output 
